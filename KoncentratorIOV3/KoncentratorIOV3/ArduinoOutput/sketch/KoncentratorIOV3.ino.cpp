#include <Arduino.h>
#line 1 "d:\\work\\sync\\smartHome\\KoncentratorIOV3\\KoncentratorIOV3\\KoncentratorIOV3.ino"
...
#define upButtonState (touchRead(T7) > 30) // digitalRead(35)
devError devErrors;
sysSettings_t sysSettings;
device_t unassigendDeviceArr[maxUnassignedDevCount];
...
#line 126 "d:\\work\\sync\\smartHome\\KoncentratorIOV3\\KoncentratorIOV3\\KoncentratorIOV3.ino"
void MQTTmsgRcvCallback(char *topic, byte *payload, unsigned int length);
#line 179 "d:\\work\\sync\\smartHome\\KoncentratorIOV3\\KoncentratorIOV3\\KoncentratorIOV3.ino"
void checkMqttQueue(void);
#line 217 "d:\\work\\sync\\smartHome\\KoncentratorIOV3\\KoncentratorIOV3\\KoncentratorIOV3.ino"
void reconnectMQTT();
#line 320 "d:\\work\\sync\\smartHome\\KoncentratorIOV3\\KoncentratorIOV3\\KoncentratorIOV3.ino"
void handleDevUpdate();
#line 369 "d:\\work\\sync\\smartHome\\KoncentratorIOV3\\KoncentratorIOV3\\KoncentratorIOV3.ino"
void handleShowDev();
#line 405 "d:\\work\\sync\\smartHome\\KoncentratorIOV3\\KoncentratorIOV3\\KoncentratorIOV3.ino"
void handleDelDev();
#line 421 "d:\\work\\sync\\smartHome\\KoncentratorIOV3\\KoncentratorIOV3\\KoncentratorIOV3.ino"
void handleAddDev();
#line 491 "d:\\work\\sync\\smartHome\\KoncentratorIOV3\\KoncentratorIOV3\\KoncentratorIOV3.ino"
void handleSetMqttBrokerForm();
#line 518 "d:\\work\\sync\\smartHome\\KoncentratorIOV3\\KoncentratorIOV3\\KoncentratorIOV3.ino"
void handleSetMqttBroker();
#line 542 "d:\\work\\sync\\smartHome\\KoncentratorIOV3\\KoncentratorIOV3\\KoncentratorIOV3.ino"
void handleDevConfig();
#line 599 "d:\\work\\sync\\smartHome\\KoncentratorIOV3\\KoncentratorIOV3\\KoncentratorIOV3.ino"
void handleAddDevForm();
#line 681 "d:\\work\\sync\\smartHome\\KoncentratorIOV3\\KoncentratorIOV3\\KoncentratorIOV3.ino"
void handleDevList();
#line 738 "d:\\work\\sync\\smartHome\\KoncentratorIOV3\\KoncentratorIOV3\\KoncentratorIOV3.ino"
void handleRoot();
#line 859 "d:\\work\\sync\\smartHome\\KoncentratorIOV3\\KoncentratorIOV3\\KoncentratorIOV3.ino"
void handleResetErrors();
#line 865 "d:\\work\\sync\\smartHome\\KoncentratorIOV3\\KoncentratorIOV3\\KoncentratorIOV3.ino"
void handleNotFound();
#line 884 "d:\\work\\sync\\smartHome\\KoncentratorIOV3\\KoncentratorIOV3\\KoncentratorIOV3.ino"
void drawGraph();
#line 904 "d:\\work\\sync\\smartHome\\KoncentratorIOV3\\KoncentratorIOV3\\KoncentratorIOV3.ino"
uint8_t countTagElements(String input, String tag);
#line 929 "d:\\work\\sync\\smartHome\\KoncentratorIOV3\\KoncentratorIOV3\\KoncentratorIOV3.ino"
void setup();
#line 1153 "d:\\work\\sync\\smartHome\\KoncentratorIOV3\\KoncentratorIOV3\\KoncentratorIOV3.ino"
void loop();
#line 1298 "d:\\work\\sync\\smartHome\\KoncentratorIOV3\\KoncentratorIOV3\\KoncentratorIOV3.ino"
void mesureTemperatures(void);
#line 1372 "d:\\work\\sync\\smartHome\\KoncentratorIOV3\\KoncentratorIOV3\\KoncentratorIOV3.ino"
void clearDevice(int devIndex);
#line 1396 "d:\\work\\sync\\smartHome\\KoncentratorIOV3\\KoncentratorIOV3\\KoncentratorIOV3.ino"
void printAddress(DeviceAddress deviceAddress);
#line 1407 "d:\\work\\sync\\smartHome\\KoncentratorIOV3\\KoncentratorIOV3\\KoncentratorIOV3.ino"
String ds18b20AddressToStr(DeviceAddress deviceAddress);
#line 1419 "d:\\work\\sync\\smartHome\\KoncentratorIOV3\\KoncentratorIOV3\\KoncentratorIOV3.ino"
void onMessage(uint8_t *buffer, size_t size);
#line 1578 "d:\\work\\sync\\smartHome\\KoncentratorIOV3\\KoncentratorIOV3\\KoncentratorIOV3.ino"
void sendDataToMQTT(int devIndex, String &data);
#line 1585 "d:\\work\\sync\\smartHome\\KoncentratorIOV3\\KoncentratorIOV3\\KoncentratorIOV3.ino"
void sendLocalDataToBlynk(void);
#line 1637 "d:\\work\\sync\\smartHome\\KoncentratorIOV3\\KoncentratorIOV3\\KoncentratorIOV3.ino"
void sendDataToBlynk(void);
#line 1693 "d:\\work\\sync\\smartHome\\KoncentratorIOV3\\KoncentratorIOV3\\KoncentratorIOV3.ino"
void displayData(void);
#line 1844 "d:\\work\\sync\\smartHome\\KoncentratorIOV3\\KoncentratorIOV3\\KoncentratorIOV3.ino"
void myTimerEvent();
#line 1869 "d:\\work\\sync\\smartHome\\KoncentratorIOV3\\KoncentratorIOV3\\KoncentratorIOV3.ino"
void tftMessage(String Message, int txtColor, int bgColor, int showTime);
#line 1892 "d:\\work\\sync\\smartHome\\KoncentratorIOV3\\KoncentratorIOV3\\KoncentratorIOV3.ino"
bool parseFormula(String formula);
#line 2050 "d:\\work\\sync\\smartHome\\KoncentratorIOV3\\KoncentratorIOV3\\KoncentratorIOV3.ino"
...
void handleShowDev()
{
    ...
    for (size_t i = 0; (i < maxOneWireChannelsInDevice) && (selDev->oneWireChannel[i].id != 0); i++)
    {
        webContent += "oneWire CH " + String(i) + " Id: " + String(selDev->oneWireChannel[i].id, HEX) + " vPin adres: " + String(selDev->oneWireChannel[i].vPinAdrr) + "<br>";
    }
...
void handleDelDev()
{
    ...
    String webContent(htmlHeader(1) + "<h2> Usunięto urządzenie </h2><br><br>\
   <a href='/dev'> Powrót </a>");
    webContent += "</body></html>";
...
void handleAddDev()
{
    ...
    uint32_t devId = strtoul(String(webServer.arg(3)).c_str(), NULL, 16);
    ...
    for (i = 5, j = 0; i < webServer.args(); j++, i += 2)
    {
        ...
        {
            sysSettings.device[devIndex].oneWireChannel[j].id = strtoul(webServer.arg(i).c_str(), NULL, 16);
    ...
    String webContent(htmlHeader(1) + " <h2> Dodano urządzenie </h2><br><br>\
   <a href='/dev'> Powrót </a>");
    webContent += "</body></html>";
...
void handleAddDevForm()
{
    ...
    webContent += "<form action='/addDev'>\
<table style='text-align:right'>\
<tr><td>\
  <label for='devType'>Typ urządzenia:</label> </td>\
<td>  <select name='devType' id='devType'>\
    <option value='1'>remIOv01</option>\
    <option value='2'>remTempSensor</option>\
    <option value='3'>localPorts</option>\
  </select></td></tr>\
<tr><td>  <label for='Opis'>Opis urządzenia:</label></td>\
<td>  <input type='text' id='Opis' name='Opis'></td></tr>\
<tr><td>  <label for='No'>Index nowego urządzenia:</label></td>\
<td>  <input type='text' id='No' name='No' value='";
    webContent += String(firstFreeDevIndex);
    webContent += "'></td></tr>\
<tr><td>  <label for='Id'>Device Id:</label></td>\
<td>  <input type='text' id='Id' name='Id' value='";
    webContent += String(unassigendDeviceArr[unassignedDevIndex].id, HEX);
    webContent += "'></td></tr>\
<tr><td>  <label for='vPin'>Wirtual pin start adres:</label></td>\
<td>  <input type='text' id='vPin' name='vPin'></td></tr>";
    // onewire config part
    for (size_t i = 0; i < maxOneWireChannelsInDevice; i++)
    {
        ...
        webContent += "<td>  <input type='text' id='" + htmlId + "' name='" + htmlId + "' value='" + String(unassigendDeviceArr[unassignedDevIndex].oneWireChannel[i].id, HEX) + "'></td>";
    ...
    webContent += "<tr><td></td><td><input type='submit' value='Dodaj'></td></tr>\
</table>\
</form>";
    webContent += "</body></html>";
...
void handleDevList()
{
    ...
    webContent += "<br><table  style='width:600px'>\
    <caption>Lista zarejestrowanych urządzeń w sytemie</caption>\
  <tr>\
    <th>No</th>\
    <th>Typ</th>\
    <th>Id</th>\
    ...
    for (size_t i = 0; i < DefinedSystemMaxDevCount; i++)
    {
        if (sysSettings.device[i].id != 0)
        {
            webContent += "<tr><td>" + String(i + 1) + "</td>";
            webContent += "<td>" + devTypeNames[sysSettings.device[i].type] + "</td>";
            webContent += "<td>" + String(sysSettings.device[i].id, HEX) + "</td>";
    ...
    webContent += "<br><br><table style='width:600px'>\
    <caption>Lista niezarejestowanych urządzeń w sytemie</caption>\
  <tr>\
    <th>No</th>\
    <th>Id</th>\
    <th>Akcja</th>\
  </tr>";
    for (size_t i = 0; i < maxUnassignedDevCount; i++)
    {
        if (unassigendDeviceArr[i].id != 0)
        {
            webContent += "<tr><td>" + String(i) + "</td>";
            webContent += "<td>" + String(unassigendDeviceArr[i].id, HEX) + "</td>";
...
void setup()
{
    ...
    if (!res)
    {
        ...
        tftMessage(String("Wifi Error: Reset"), TFT_WHITE, TFT_RED, 4000);
        ESP.restart();
    }
    else
    {
        ...
        Serial.println("connected :)");
        tftMessage(String("Wifi OK!"), TFT_GREEN, TFT_BLACK, 1000);
        tftMessage(String("IP: ") + String(WiFi.localIP()[0]) + "." + WiFi.localIP()[1] + "." + WiFi.localIP()[2] + "." + WiFi.localIP()[3], TFT_GREEN, TFT_BLACK, 4000);
    }
    ...
    if (!LoRaNow.begin())
    {
        ...
        tftMessage(String("Lora Error: Reset"), TFT_WHITE, TFT_RED, 4000);
        ESP.restart();
    }
    ...
    if ((millis() - time) > 10000)
    {
        ...
        tftMessage(String("Brak odpowiedzi z Blynk: Reset"), TFT_WHITE, TFT_RED, 4000);
        ESP.restart();
    }
    ...
    tftMessage(String("Lokalnie ") + String(i) + (i == 1 ? String(" czujnik") : String(" czujniki")), TFT_GREEN, TFT_BLACK, 2000);

    //*********************** MCP23017 - extIO ******************************
    if (!extIO.begin_I2C())
    {
        tftMessage(String("extIO Error!!!"), TFT_WHITE, TFT_RED, 4000);
        ESP.restart();
    }
    for (i = 0; i < 16; i++)
        i < 8 ? extIO.pinMode(i, INPUT_PULLUP) : extIO.pinMode(i, OUTPUT);
    ...
    { // simple check that data fits
        tftMessage(String("error read sys data!!!"), TFT_WHITE, TFT_RED, 4000);
        ESP.restart();
    }
    else
    {
...
void mesureTemperatures(void)
{
    ...
    if (i == maxOneWireChannelsInDevice)
    {
        for (j = 0; j < maxUnassignedDevCount; j++)
        {
            ...
            else
            {
                ...
                {
                    for (size_t k = 0; (k < localSensorsCount) && (k < maxOneWireChannelsInDevice); k++)
                        unassigendDeviceArr[j].oneWireChannel[k].id = strtoul(ds18b20AddressToStr(sensorsAddr[k]).c_str(), NULL, 16);
                }
                unassigendDeviceArr[j].DI_PortCfg.count = DI_localCount;
                unassigendDeviceArr[j].DO_PortCfg.count = DO_localCount;
                unassigendDeviceArr[j].AI_PortCfg.count = AI_localCount;
                unassigendDeviceArr[j].AO_PortCfg.count = AO_localCount;
            }
    ...
    for (size_t i = 0; i < sysSettings.SystemMaxDevCount; i++)
    {
        ...
        {
            for (size_t j = 0; j < maxOneWireChannelsInDevice; j++)
            {
...
void clearDevice(int devIndex)
{
    ...
    for (size_t i = 0; i < maxPinCountInPort; i++)
    {
...
void onMessage(uint8_t *buffer, size_t size)
{
    ...
    if (i == DefinedSystemMaxDevCount)
    {
        ...
        {
            bool _break = false;
            for (i = 0; i < maxUnassignedDevCount; i++)
            ...
            if (unassigendDeviceArr[j].id == 0)
            {
                ...
                if (loraMessege.containsKey("CHs"))
                {
                    ...
                    for (size_t k = 0; (k < CHs) && (k < maxOneWireChannelsInDevice); k++)
                        unassigendDeviceArr[j].oneWireChannel[k].id = strtoul(loraMessege["ChIds"][k], NULL, 16);
                }
...
void sendLocalDataToBlynk(void)
{
    ...
    if (devIndex >= 0)
    {
        ...
        if (localSensorsCount > 0)
        {
            for (i = 0; (i < maxOneWireChannelsInDevice) && (i < localSensorsCount) && (sysSettings.device[devIndex].oneWireChannel[i].id != 0); i++)
            {
                int8_t sensorIndex = -1;
                for (size_t j = 0; j < localSensorsCount; j++)
                {
                    if (sysSettings.device[devIndex].oneWireChannel[i].id == strtoul(ds18b20AddressToStr(sensorsAddr[j]).c_str(), NULL, 16))
                    {
                        sensorIndex = j;
                        break;
                    }
...
void sendDataToBlynk(void)
{
    ...
    { // jezeli posiada dane 1-wire
        ...
        {
            for (i = 0; (i < maxOneWireChannelsInDevice) && (sysSettings.device[devIndex].oneWireChannel[i].id != 0); i++)
            {
                int8_t loraIndex = -1;
                for (size_t j = 0; j < loraMessege["CHs"]; j++)
                {
                    if (sysSettings.device[devIndex].oneWireChannel[i].id == strtoul(loraMessege["ChIds"][j], NULL, 16))
                    {
                        loraIndex = j;
                        break;
                    }
...
void displayData(void)
{
    ...
    // Serial.println("start wyswietlania");
    {
        ...
        for (size_t i = 0; i < 8; i++)
        {
            if (statePortIn & (1 << i))
            {
                tft.setTextColor(TFT_BLACK, offColor);
                fillColor = offColor;
            }
            else
            {
                tft.setTextColor(TFT_BLACK, onColor);
                fillColor = onColor;
            }
