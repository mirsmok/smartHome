...
void loop()
{
    ...
    {
        M5.Lcd.printf("Wifi ok ip: %d.%d.%d.%d", WiFi.localIP()[0], WiFi.localIP()[1], WiFi.localIP()[2], WiFi.localIP()[3]);
        wifiConnected = true;
    }
    ...
    if (millis() - Time > 5000)
    {
        ...
        M5.Lcd.fillRect(0, 20, 320, 40, BLACK);
        M5.Lcd.printf("klientow: %d", clientCount);
    }
    ...
    /*   display.clear();
       ...
       display.drawString(64, 35, "MQTT clients: " + String(clientCount));
       display.display();*/
}
void myTimerEvent()
{
